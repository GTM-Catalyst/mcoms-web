...
![Integration of MCOMS interfaces.](./assets/1.3.1_IntMCOMInterf.png)

The following sections describe each interface.

### Customer App
#### Figure 5: Screenshot of the customer app.
![Screenshot of the customer app.](./assets/SVG/1.3.1.2_Customer_App.svg)
...
![Data flow between MCOMS components](./assets/SVG/1.3.5_DataFlow_between_Components.svg)
...
![Benefits of smart metering](./assets/SVG/1.3.6_Benefit_of_Smart_Metering.svg)
